...
export declare function createPreviewElement(options: CreatePreviewElementOptions): React.ReactElement;
export declare function mountPreview(options: MountPreviewOptions): PreviewMountedHandle;
export declare function hydratePreview(options: HydratePreviewOptions): PreviewMountedHandle;
export declare function renderPreviewToString(options: RenderPreviewToStringOptions): string;
export declare function renderPreviewToStaticMarkup(options: RenderPreviewToStringOptions): string;
