...
export declare function resolvePreviewRuntimeModule(runtimeModule: string | undefined, baseDir: string): string | undefined;
export declare function defineConfig(config: PreviewConfig): PreviewConfig;
export declare function createPackageTargetDiscovery(options?: PreviewTargetDiscoveryFactoryOptions): PreviewTargetDiscoveryAdapter;
export declare function createStaticTargetsDiscovery(targets: PreviewSourceTarget[]): PreviewTargetDiscoveryAdapter;
export declare function createWorkspaceTargetsDiscovery(options?: PreviewWorkspaceTargetDiscoveryOptions): PreviewTargetDiscoveryAdapter;
export declare function loadPreviewConfig(options?: LoadPreviewConfigOptions): Promise<ResolvedPreviewConfig>;
export declare function loadPreviewBuildConfig(options?: LoadPreviewConfigOptions): Promise<ResolvedPreviewConfig>;
export declare function resolvePreviewConfigObject(config: PreviewConfig, options?: {
    configDir?: string;
    cwd?: string;
