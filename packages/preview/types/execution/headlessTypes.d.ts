import type { PreviewEngineSnapshot, PreviewEntryPayload } from "@loom-dev/preview-engine";
...
export type PreviewHeadlessRenderStatus = "load_failed" | "render_failed" | "rendered" | "skipped";
...
export declare function classifyHeadlessExecutionResult(entryPayload: PreviewEntryPayload, executionResult: Omit<PreviewHeadlessEntryExecutionResult, "severity">): "error" | "warning" | "pass";
export declare function summarizeHeadlessExecution(entryPayloads: Record<string, PreviewEntryPayload>, executionEntries: Record<string, PreviewHeadlessEntryExecutionResult>, selectedEntryCount: number): PreviewHeadlessExecutionSummary;
