...
export declare function normalizeViteLogErrorOptions<TOptions extends import("vite").LogErrorOptions>(options?: TOptions): TOptions | undefined;
export { resolvePreviewRuntimeRootEntry } from "./previewPackagePaths";
export declare function resolvePreviewServerConfig(options?: StartPreviewServerInput): Promise<ResolvedPreviewConfig>;
export declare function startPreviewServer(options?: StartPreviewServerInput, runtimeOptions?: PreviewServerProgressOptions): Promise<import("vite", { with: { "resolution-mode": "import" } }).ViteDevServer>;
export declare function createPreviewViteServer(resolvedConfig: ResolvedPreviewConfig, options?: CreatePreviewViteServerOptions): Promise<import("vite", { with: { "resolution-mode": "import" } }).ViteDevServer>;
