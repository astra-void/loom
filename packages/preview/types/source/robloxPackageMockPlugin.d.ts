...
export declare const UNRESOLVED_MOCK_MODULE_ID = "virtual:loom-preview-unresolved-env";
export declare const ROBLOX_MOCK_MODULE_ID = "virtual:loom-preview-unresolved-env";
...
export declare function createUnresolvedPackageMockResolvePlugin(mockEntryPath: string, options?: RobloxPackageMockPluginOptions): Plugin;
export declare function createUnresolvedPackageMockTransformPlugin(options?: RobloxPackageMockPluginOptions): Plugin;
