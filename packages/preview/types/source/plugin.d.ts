import { type PreviewEngine, type PreviewExecutionMode, type PreviewSourceTarget } from "@loom-dev/preview-engine";
...
export declare function createPreviewVitePlugin(options: CreatePreviewVitePluginOptions): PreviewPluginOption[];
