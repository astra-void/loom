...
export type { PreviewHeadlessEntryExecutionResult, PreviewHeadlessExecution, PreviewHeadlessExecutionSummary, PreviewHeadlessRenderStatus, PreviewHeadlessSnapshot, } from "./execution/headlessTypes";
...
export type PreviewHeadlessSession = {
    ...
    run(options?: PreviewHeadlessSessionRunOptions): Promise<PreviewHeadlessSnapshot>;
};
export type CreatePreviewHeadlessSessionOptions = StartPreviewServerInput;
export declare function createPreviewHeadlessSession(options?: CreatePreviewHeadlessSessionOptions): Promise<PreviewHeadlessSession>;
