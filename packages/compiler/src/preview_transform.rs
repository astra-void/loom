...
const PREVIEW_ENUM_LITERAL_MAPPINGS: &[(&str, &str)] = &[
    ...
    ("Enum.StartCorner.TopLeft", "top-left"),
    ("Enum.StartCorner.TopRight", "top-right"),
    ("Enum.StartCorner.BottomLeft", "bottom-left"),
    ("Enum.StartCorner.BottomRight", "bottom-right"),
    ("Enum.DominantAxis.Width", "width"),
    ("Enum.DominantAxis.Height", "height"),
    ...
    ("Enum.UIFlexMode.Fill", "fill"),
    ("Enum.UIFlexMode.Grow", "grow"),
    ("Enum.UIFlexMode.Shrink", "shrink"),
    ("Enum.UIFlexMode.Custom", "custom"),
    ("Enum.UIFlexAlignment.None", "none"),
    ("Enum.UIFlexAlignment.Fill", "fill"),
    ("Enum.UIFlexAlignment.SpaceAround", "space-around"),
    ("Enum.UIFlexAlignment.SpaceBetween", "space-between"),
    ("Enum.UIFlexAlignment.SpaceEvenly", "space-evenly"),
