...
export type CliBuildTransformMode = "strict-fidelity" | "compatibility" | "mocked" | "design-time";
export type CliPreviewBuildArtifactKind = "module" | "entry-metadata" | "layout-schema";
...
export interface CliPreviewHeadlessSnapshotEntry {
    descriptor: {
        id: string;
        relativePath: string;
        status: "ambiguous" | "blocked_by_layout" | "blocked_by_runtime" | "blocked_by_transform" | "needs_harness" | "ready";
        targetName: string;
        title: string;
    };
...
export interface CliPreviewModule {
    ...
    createPreviewHeadlessSession(options?: CliResolvedPreviewConfig): Promise<CliPreviewHeadlessSession>;
    loadPreviewConfig(options?: {
        configFile?: string;
        cwd?: string;
    }): Promise<CliResolvedPreviewConfig>;
    startPreviewServer(options?: CliResolvedPreviewConfig, runtimeOptions?: {
...
export declare function runPreviewCommand(options: PreviewCommandOptions, runtimeOverrides: Partial<CliCommandRuntime>): Promise<void>;
export declare function runSnapshotCommand(options: SnapshotCommandOptions, runtimeOverrides: Partial<CliCommandRuntime>): Promise<void>;
export declare function runCheckCommand(options: CheckCommandOptions, runtimeOverrides: Partial<CliCommandRuntime>): Promise<void>;
export declare function runBuildCommand(options: BuildCommandOptions, runtimeOverrides: Partial<CliCommandRuntime>): Promise<void>;
export declare function runConfigCommand(options: ConfigCommandOptions, runtimeOverrides: Partial<CliCommandRuntime>): Promise<void>;
