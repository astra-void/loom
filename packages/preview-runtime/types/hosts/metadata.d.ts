...
export declare const previewHostMetadataByJsxName: Map<string, {
    abstractAncestors: string[];
    degraded: boolean;
    domTag: string;
    fullSizeDefault: boolean;
...
export declare const previewHostMetadataByRuntimeName: Map<string, {
    abstractAncestors: string[];
    degraded: boolean;
    domTag: string;
    fullSizeDefault: boolean;
...
export declare function getPreviewHostMetadataByRuntimeName(runtimeName: string): {
    abstractAncestors: string[];
    degraded: boolean;
    domTag: string;
    fullSizeDefault: boolean;
...
export declare function getPreviewPlaceholderBehaviorByJsxName(jsxName: string): PreviewPlaceholderBehavior;
export declare function getPreviewPlaceholderBehaviorByRuntimeName(runtimeName: string): PreviewPlaceholderBehavior;
export declare function isPreviewHostTypeSupported(typeName: string, kind: "isa" | "typeRewrite"): boolean;
export declare function previewHostMatchesType(jsxName: string, typeName: string, kind?: "isa" | "typeRewrite"): boolean;
export declare function isDegradedPreviewHost(jsxName: string): boolean;
export declare function isContainerDegradedPreviewHost(jsxName: string): boolean;
