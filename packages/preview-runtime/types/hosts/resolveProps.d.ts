...
export declare function applyComputedLayoutStyle(style: React.CSSProperties, computed: ComputedRect | null, parentRect?: ComputedRect | null): void;
export declare function resolvePreviewDomProps(props: PreviewDomProps, options: ResolveOptions): ResolvedPreviewDomProps;
