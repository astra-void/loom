...
export declare function toFiniteNumber(
	value: unknown,
	fallback?: number,
): number;
export declare function normalizePreviewNodeId(
	nodeId: string | undefined,
): string | undefined;
export declare function normalizeLegacyPreviewResultNodeId(
	nodeId: string | undefined,
): string | undefined;
export declare function serializeUDim(
	value: unknown,
	fallback?: SerializedUDim,
): SerializedUDim;
export declare function serializeUDim2(
	value: unknown,
	fallback?: SerializedUDim2,
): SerializedUDim2 | undefined;
export declare function serializeVector2(
	value: unknown,
	fallback?: SerializedVector2,
): SerializedVector2;
