...
import { adaptRobloxNodeInput, type ComputedRect, type PreviewLayoutDebugNode, type PreviewLayoutDebugPayload, type PreviewLayoutNode, type RobloxLayoutRegistrationInput } from "./model";
...
type PreviewLayoutProbeListener = (snapshot: PreviewLayoutProbeSnapshot) => void;
export declare function getPreviewLayoutProbeSnapshot(): PreviewLayoutProbeSnapshot;
export declare function subscribePreviewLayoutProbe(listener: PreviewLayoutProbeListener): () => void;
...
export declare function LayoutProvider(props: LayoutProviderProps): import("react/jsx-runtime").JSX.Element;
...
export declare function useRobloxLayout(input: RobloxLayoutRegistrationInput | PreviewLayoutNode): ComputedRect | null;
