...
export declare function resolveNodeHostPolicy(
...
export declare function createViewportRect(
	width: number,
	height: number,
): ComputedRect;
export declare function normalizeRootScreenGuiNode(
...
export declare function adaptRobloxNodeInput(
	input: RobloxLayoutRegistrationInput,
	parentId: string | undefined,
): PreviewLayoutNode;
export declare function areNodesEqual(
	a: PreviewLayoutNode,
	b: PreviewLayoutNode,
): boolean;
export declare function resolveNodeSize(
	node: Pick<
		PreviewLayoutNode,
		"hostMetadata" | "intrinsicSize" | "kind" | "layout"
	>,
): PreviewResolvedNodeSize;
export declare function computeRectFromParentRect(
	node: Pick<
		PreviewLayoutNode,
		"hostMetadata" | "intrinsicSize" | "kind" | "layout"
	>,
...
export declare function computeNodeRect(
	node: PreviewLayoutNode,
	parentRect: ComputedRect,
): {
	layoutSource: PreviewLayoutSource;
...
export declare function normalizeLayoutMap(
	raw: unknown,
): Record<string, ComputedRect>;
export declare function normalizePreviewLayoutResult(
	raw: unknown,
	viewport: {
		height: number;
		width: number;
