...
export type PreviewLayoutEngineModuleOrPath = ArrayBuffer | Promise<ArrayBuffer | Uint8Array | URL | WebAssembly.Module | string> | Uint8Array | URL | WebAssembly.Module | string;
...
export declare function sanitizePreviewLayoutNodes(nodes: PreviewLayoutNode[]): PreviewLayoutNode[];
export declare function setPreviewLayoutEngineLoader(loader: PreviewLayoutEngineLoader | null): void;
...
export declare function initializeLayoutEngine(options?: PreviewLayoutEngineInitOptions): Promise<void>;
