...
export declare function delay<TArgs extends readonly unknown[]>(
	seconds: number,
	callback: TaskCallback<TArgs>,
	...args: TArgs
): number;
export declare function spawn<TArgs extends readonly unknown[], TResult>(
	callback: (...args: TArgs) => TResult,
	...args: TArgs
): TResult | undefined;
export declare function defer<TArgs extends readonly unknown[]>(
	callback: TaskCallback<TArgs>,
	...args: TArgs
): void;
