...
export type PreviewRuntimeIssueKind = "ModuleLoadError" | "TransformExecutionError" | "TransformValidationError" | "UnsupportedPatternError" | "RuntimeMockError" | "LayoutExecutionError" | "LayoutValidationError";
...
export declare class PreviewRuntimeError extends Error {
    ...
    constructor(kind: PreviewRuntimeIssueKind, options: PreviewRuntimeErrorOptions);
...
export declare function subscribePreviewRuntimeIssues(listener: PreviewRuntimeIssueListener): () => void;
export declare function setPreviewRuntimeIssueContext(context: PreviewRuntimeIssueContext | null): void;
export declare function normalizePreviewRuntimeError(context: PreviewRuntimeIssueContext, error: unknown): PreviewRuntimeIssue;
export declare function publishPreviewRuntimeIssue(issueOrError: PreviewRuntimeIssue | PreviewRuntimeError | unknown, context?: PreviewRuntimeIssueContext): PreviewRuntimeIssue;
/**
 * @deprecated use `publishPreviewRuntimeIssue(normalizePreviewRuntimeError(...))`
 */
export declare function reportPreviewRuntimeError(scope: string, error: unknown): void;
export {};
