...
declare function stringFind(value: string, pattern: string, init?: number, plain?: boolean): readonly [number, number] | undefined;
declare function stringGsub(value: string, pattern: string, replacement: string | ((match: string, ...captures: string[]) => unknown)): readonly [string, number];
declare function stringSub(value: string, start?: number, finish?: number): string;
...
export declare function typeIs(value: unknown, typeName: "string" | "number" | "boolean" | "function" | "table"): boolean;
export declare function pairs(value: unknown): Generator<readonly [PropertyKey, unknown], void, unknown>;
export declare function next(value: unknown, index?: PropertyKey | null): readonly [PropertyKey | undefined, unknown | undefined];
...
export declare function isPreviewElement(value: unknown, typeName: string): value is HTMLElement;
export declare function __previewGlobal(name: string): unknown;
export declare function toCssLength(dimension: UDim): string;
export declare function toCssColor(color: Color3Value, backgroundTransparency?: number): string;
export {};
