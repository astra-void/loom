...
export type UDimLike =
	| { Scale?: number; Offset?: number; scale?: number; offset?: number }
...
export function normalizePreviewNodeId(
...
export function serializeUDim(
	value: unknown,
	fallback: SerializedUDim = ZERO_UDIM,
): SerializedUDim {
...
export function serializeUDim2(
	value: unknown,
...
export function serializeVector2(
	value: unknown,
	fallback: SerializedVector2 = ZERO_VECTOR2,
): SerializedVector2 {
	if (Array.isArray(value)) {
		return {
