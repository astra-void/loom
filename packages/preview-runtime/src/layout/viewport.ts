...
export function createWindowViewport(): ViewportSize {
	...
	return {
		height:
			toPositiveViewportDimension(window.innerHeight) ??
			DEFAULT_VIEWPORT_HEIGHT,
		width:
			toPositiveViewportDimension(window.innerWidth) ?? DEFAULT_VIEWPORT_WIDTH,
	};
}
...
export function hasPositiveViewport(
