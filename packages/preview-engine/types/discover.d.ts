...
import type { CreatePreviewEngineOptions, PreviewEntryDescriptor, PreviewWorkspaceIndex } from "./types";
type TargetContext = {
    exclude?: string[];
    include?: string[];
    packageName: string;
...
export declare function discoverWorkspaceState(options: Pick<CreatePreviewEngineOptions, "projectName" | "targets" | "workspaceRoot">): {
    entryDependencyPathsById: Map<string, string[]>;
    entryStatesById: Map<string, DiscoveredEntryState>;
    workspaceIndex: {
