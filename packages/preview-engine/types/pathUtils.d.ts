...
export declare function isFilePathUnderRoot(rootPath: string, filePath: string): boolean;
export declare function isFilePathIncludedByTarget(target: Pick<PreviewSourceTarget, "exclude" | "include" | "sourceRoot">, filePath: string): boolean;
