...
import type { PreviewTransformDiagnostic, PreviewTransformMode, PreviewTransformOutcome, TransformPreviewSourceOptions, TransformPreviewSourceResult } from "./transformTypes";
export type { PreviewTransformDiagnostic, PreviewTransformMode, PreviewTransformOutcome, } from "./transformTypes";
export declare const PREVIEW_ENGINE_PROTOCOL_VERSION = 4;
export type PreviewPropKind = "array" | "bigint" | "boolean" | "function" | "literal" | "number" | "object" | "react-element" | "react-node" | "string" | "union" | "unknown";
...
export type PreviewEntryStatus = "ready" | "needs_harness" | "ambiguous" | "blocked_by_transform" | "blocked_by_runtime" | "blocked_by_layout";
...
export type PreviewEntryStatusDetails = PreviewReadyStatusDetails | {
    candidates?: string[];
    kind: "needs_harness";
...
export type PreviewDiscoveryDiagnosticCode = "AMBIGUOUS_COMPONENT_EXPORTS" | "DECLARATION_ONLY_BOUNDARY" | "GRAPH_CYCLE_DETECTED" | "MISSING_EXPLICIT_PREVIEW_CONTRACT" | "NO_COMPONENT_EXPORTS" | "PREVIEW_RENDER_MISSING" | "UNRESOLVED_IMPORT";
...
export type PreviewGraphStopReason = "declaration-only-boundary" | "external-dependency" | "graph-cycle" | "unresolved-import";
...
export type PreviewGraphImportEdge = {
    ...
    resolutionKind?: "declaration-file" | "external-dependency" | "project-reference-source" | "source-file" | "workspace-package";
    resolvedFile?: string;
