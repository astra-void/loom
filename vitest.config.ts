...
const layoutEngineWasmPath = path.resolve(workspaceRoot, "packages/layout-engine/pkg/layout_engine_bg.wasm");
...
export default defineConfig({
    ...
    alias: [
      {
        ...
        replacement: path.resolve(workspaceRoot, "packages/compiler/wrapper.mjs"),
      },
      {
      ...
      },
      {
        ...
        replacement: path.resolve(workspaceRoot, "packages/layout-engine/pkg/layout_engine.js"),
      },
      {
  ...
  optimizeDeps: {
    exclude: ["@loom-dev/layout-engine", "@loom-dev/layout-engine/layout_engine_bg.wasm?url"],
  },
  test: {
